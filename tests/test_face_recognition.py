...
class Test_face_recognition(unittest.TestCase):
    ...
    def test_face_landmarks_small_model(self):
        ...
        self.assertEqual(set(face_landmarks[0].keys()),
    ...
    def test_command_line_interface(self):
        ...
        result = runner.invoke(face_recognition_cli.main,
                               args=[image_folder, image_file])
    ...
    def test_fd_command_line_interface_hog_model(self):
        ...
        result = runner.invoke(face_detection_cli.main,
                               args=[image_file, "--model", "hog"])
        self.assertEqual(result.exit_code, 0)
        self.assertTrue(target_string in result.output)
